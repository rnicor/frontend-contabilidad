...
export class LibroDiarioService {
    ...
    constructor(
        ...
        this.url = environment.apiEndpoint + 'api/visualizacion-comprobante';
    }

    inicio(): Observable<VisualizacionCompronbanteInicio> {
        return this.http.get(`${this.url}/inicio`, this.httpOptions).pipe(
            map(response => response as VisualizacionCompronbanteInicio),
