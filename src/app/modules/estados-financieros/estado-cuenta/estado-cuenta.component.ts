...
import {EstadoCuentaService} from './service/estado-cuenta.service';
...
export class RegistroComprobanteComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.estadoCuentaService.inicio().subscribe(
            (response) => {
    ...
    buscar(): void {;
        ...
        this.mesTipo.mes = 6;
        console.log( this.mesTipo);
        this.estadoCuentaService.buscar(this.mesTipo).subscribe(
            (response) => {
