...
import {EstadoFinacieroService} from './service/estado-financiero.service';
...
export class RegistroComprobanteComponent implements OnInit {
    ...
    constructor(
        private estadoFinacieroService: EstadoFinacieroService,
    ...
    ngOnInit(): void {
        ...
        this.estadoFinacieroService.inicio().subscribe(
            (response) => {
    ...
    buscar(): void {;
        ...
        this.mesTipo.mes = 6;
        console.log( this.mesTipo);
        this.estadoFinacieroService.buscar(this.mesTipo).subscribe(
            (response) => {
