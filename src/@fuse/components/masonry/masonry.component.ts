...
export class FuseMasonryComponent implements OnChanges, AfterViewInit
{
    ...
    {
        // Distribute the ingreso for the first time
        this._distributeItems();
    }
    ...
    /**
     * Distribute ingreso into columns
     */
    private _distributeItems(): void
    {
        // Return an empty array if there are no ingreso
        ...
        // Distribute the ingreso to columns
